      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16 max-w-2xl mx-auto">
          ...
          <AnimatedParagraph className="text-slate-500 font-sans text-sm sm:text-base leading-relaxed">
            From modern automated talent pipelines to secure employee systems
        ...
        >
          ...
          >
            ...
            <p className="text-slate-500 font-sans text-xs sm:text-sm leading-relaxed">
              We prioritize your needs, providing tailored solutions to enhance
          ...
          >
            ...
            <p className="text-slate-500 font-sans text-xs sm:text-sm leading-relaxed">
              Your data is safe with us. We employ strong security protocols to
          ...
          >
            ...
            <p className="text-slate-500 font-sans text-xs sm:text-sm leading-relaxed">
              Our professional consulting services help you align your HR
              strategies with your business goals seamlessly.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-500 font-sans text-xs sm:text-sm leading-relaxed">
              Our solutions are flexible, designed to scale and adapt to the
